...
class SignupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post signups_url, params: { signup: { email: @signup.email, firstname: @signup.firstname, lastname: @signup.lastname, password: @signup.password, phone: @signup.phone } }
    end
  ...
  test "should update signup" do
    patch signup_url(@signup), params: { signup: { email: @signup.email, firstname: @signup.firstname, lastname: @signup.lastname, password: @signup.password, phone: @signup.phone } }
